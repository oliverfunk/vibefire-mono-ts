...
export const genEvent = async () => {
  ...
  const titles = [
    ...
    "Spring Gala Event",
    "Fundraising Charity Gala",
    "Picnic in the Community",
    ...
    "Reading of Poetry",
    "Mixer for Networking",
    "Bootcamp for Fitness",
    "Class for Cooking",
    "Series of Webinars",
    "Launch of New Product",
    "Hackathon for Creatives",
    "Fair for Careers",
    "Session for Workshops",
  ];
  ...
  const descriptions = [
    ...
    "Celebrate with us at our Grand Annual Celebration, a night filled with entertainment, gourmet food, and joyous festivities.",
    "Welcome the spring season at our Gala Event. Enjoy a night of live performances, exquisite food, and wonderful company.",
    "Join our Fundraising Charity Gala and make a difference. Every ticket contributes to a good cause.",
    "Gather with your family and friends at our Picnic in the Community. Enjoy a day filled with fun games, tasty food, and outdoor activities.",
    "Get into the festive spirit at our Holiday Shopping Market. Discover unique gifts, enjoy seasonal treats, and more.",
    "Appreciate the creativity of local artists at our Exhibition of Art. Explore new art pieces and interact with the creators.",
    "Stay updated with the latest industry trends at our Conference on Technology. Learn from experts and network with professionals.",
    "Witness startups as they present their innovative ideas at our Pitch Night for Startups.",
    "Spend a day enjoying live performances from a variety of amazing artists at our Festival of Music.",
    "Join our Screening of Films event. Watch award-winning films and engage in discussions with fellow movie enthusiasts.",
    "Join our Meeting of Book Club. Discuss your favorite books and discover new ones.",
    "Experience the beauty of words at our Reading of Poetry event. Listen to established and emerging poets.",
    "Expand your professional network at our Mixer for Networking. Connect with industry leaders and like-minded professionals.",
    "Get fit and have fun at our Bootcamp for Fitness. Everyone is welcome, regardless of fitness level.",
    "Learn new recipes and cooking techniques at our Class for Cooking. No prior experience needed!",
    "Join our Series of Webinars to learn about a variety of topics from the comfort of your own home.",
    "Be the first to see our latest product at our Launch of New Product. Discover its features and meet the team behind it.",
    "Bring your ideas to life at our Hackathon for Creatives. Collaborate, create, and solve challenges.",
    "Explore career opportunities at our Fair for Careers. Meet potential employers and learn about different industries.",
    "Learn new skills and deepen your understanding of a topic at our Session for Workshops.",
  ...
  const rndTitle = getRandomItem(titles);
  const rndDesc = getRandomItem(descriptions);
